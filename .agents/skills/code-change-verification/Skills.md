...
- モバイルで主要映像が横スクロール前提になっていないか
- 共有画面あり / なし の両方で、PC とスマホの表示優先順位が意図どおりか
...
# webrtc3 の UI 修正時に最低限見ること
- PC で共有画面が主表示として自然に見える
- スマホで主要映像が初見で見える
- 参加者カメラが横スワイプ前提になっていない
- 共有なし状態でも映像が見えている
- 共有あり状態で参加者カメラの補助表示が破綻していない
