...
6. BAN 判定関数を追加
7. `profiles.nickname` 読み出しと更新関数を追加
8. SkyWay join 用内部名の生成関数を追加
9. 最後に routing 側へ接続する
...
Google ログイン、rooms / profiles / banned_users、BAN 判定、RLS 前提の browser client、`profiles.nickname` の管理、SkyWay join 用内部名の分離に限定してください。
